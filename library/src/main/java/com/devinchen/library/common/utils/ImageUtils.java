 ...
 * Created by Devin Chen on 2017/5/15 23:01.
 * explain:图像加载处理工具
 */
...
public class ImageUtils extends UtilsManager {
     ...
     */
    public static void loadFitWidth(Context context, final String imageUrl, int errorImageId, final ImageView imageView) {
        Glide.with(context)
                .load(imageUrl)
